...
import { setMonopoliScore } from '../redux/actions';
                    ...
                    <div className="container">
                        <div className="row d-flex flex-column justify-content-center align-items-center" style={{ minHeight: "100vh" }} >
                            <div className="col-11 d-flex flex-column justify-content-center">
                                <h1 className="text-center text-uppercase mt-5" style={{ color: "black" }}> Total Score = {props.monopoliScore}  </h1>

                                <button className='btn btn-primary' onClick={() => { clickHandel(props) }}>get score</button>
                            </div>
                        </div>
                    </div>
                </section>
