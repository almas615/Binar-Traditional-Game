    ...
    return (
      <div>
         <div className={styles.background}>
                ...
                <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.2/dist/css/bootstrap.min.css" rel="stylesheet"></link>
                    <div className="row align-items-center">
                    <div className="col-1 fs-1 fw-bolder text-end custom-back-button">
                        <a style={{color: '#724C21'}} href='/listgames'>&lt;</a>
                    </div>
                    <div className="col-1 text-center">
                        <img src="/logo.png" width={60} height={60} className="custom-logo" />
                    </div>

                    <div className="col fs-2 fw-bold custom-game-title" style={{color: '#F9B23D'}}>
                        ROCK PAPER SCISSOR
                    </div>
                    </div>
                ...
                <div className="container text-center custom-game-section">
                    ...
                    <div className="col-2 custom-choice-background align-items-center" id="player-rock">
                        <Image className="custom-choice" src='/batu.png' width={120} height={85}/>
                    </div>
                    <div className="col-2">
                    </div>
                    ...
                    <Image className="custom-choice" src='/kertas.png' width={95} height={100}/>
                    </div>
                    <div className="col-2 mx-2 fw-bold custom-vs-background custom-vs-text" id="vs" style={{color: '#BD0000', fontSize: '4rem'}}>
                        VS
                    </div>
                    ...
                    <Image className="custom-choice" src='/gunting.png' width={100} height={105}/>
                    </div>
                    <div className="col-2">
                    </div>
                    ...
                    <Image className="custom-choice" src='/refresh.png' width={100} height={90}/>
                    </div>
                    <div className="col-2">
                    </div>
                    </div>
